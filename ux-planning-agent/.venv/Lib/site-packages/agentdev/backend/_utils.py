from agent_framework import Message, AgentExecutorResponse
...
def serialize_data(data: Any, max_depth: int = 10) -> Any:
    ...
    Handles complex types like Message, AgentExecutorResponse, dataclasses,
    ...
    # Handle Message - Fallback if to_dict failed or is not available
